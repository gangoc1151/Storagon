...
//             allFiles.push({ id: item.pk.toString(), name: item.fields.name, isDirectory: true })
//         })
...
export default function* rootSaga() {
    yield [
        // yield takeLatest(actions.GET_FILE, getFiles),
        // yield takeLatest(actions.UPDATE_FOLDER, updateFolder),
        // yield takeLatest(actions.MOVE_FILE, moveFile),
        // yield takeLatest(actions.DELETE_FILE, deleteFile),
        // yield takeLatest(actions.EDIT_FILE, editFile),
        // yield takeLatest(actions.NEW_FOLDER, newFolder),
        // yield takeLatest(actions.MOVE_FOLDER, moveFolder),
        // yield takeLatest(actions.DELETE_FOLDER, deleteFolder),
        // yield takeLatest(actions.EDIT_FOLDER, editFolder),
        // yield takeLatest(actions.SET_FILE_PREMIUM, setFilePremium),
    ]
}